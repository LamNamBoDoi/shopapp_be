...
public interface IProductService {
    ...
    Product updateProduct(Long id, ProductDTO productDTO) throws DataNotFoundException, IOException;
    ...
    ProductResponse getDetailProducts(long productId) throws Exception;
